...
docker run --name meal-container --net network-mongo -e SERVER_PORT=6666 -e MONGODB_HOST=mongo-container -e MONGODB_PORT=27017 -e MONGODB_DBNAME=meal-org -e MONGODB_USER=admin -e MONGODB_PASSWORD=admin -d meal-microservice